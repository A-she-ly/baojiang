...
def build_cards(scenes: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    cards_raw = [
        ...
        ("gotta", "/ˈɡɒtə/", "contraction (got to)", "B1", "short_o+schwa", ["contraction", "连读", "口语缩写"],
        ...
        ("hump", "/hʌmp/", "n. 驼背；隆起", "C1", "short_u", ["身体词汇", "幽默"],
        ...
        ("bemused", "/bɪˈmjuːzd/", "adj. 困惑的；茫然的", "B2", "juice_diphthong", ["情绪词", "CET6"],
         "(They all stare, ___.)",
         "(They all stare, bemused.)",
         "（大家都一脸困惑地盯着Phoebe。）",
         "注意不要和 amused（被逗乐）搞混！前缀 be- + muse（沉思）→ 陷入沉思而发懵。",
         "Central Perk", "bemused"),

        ("drifted apart", "/ˈdrɪftɪd əˈpɑːt/", "phrasal verb 渐行渐远", "B2", "short_i", ["phrasal_verb", "关系"],
        ...
        ("turned on by", "/tɜːnd ɒn baɪ/", "phrase 被…吸引；对…有性趣", "B2", "r-controlled_vowel", ["俚语", "phrasal"],
        ...
        ("gravy boat", "/ˈɡreɪvi bəʊt/", "n. 船形调味汁碟", "B2", "long_a", ["生活词汇", "餐具"],
        ...
        ("freaked out", "/friːkt aʊt/", "phrasal verb 崩溃；吓尿", "B1", "long_e", ["phrasal_verb", "情绪"],
        ...
        ("hit on her", "/hɪt ɒn hɜː/", "phrase 搭讪；撩", "B2", "short_i", ["俚语", "phrasal", "约会"],
         "Joey, stop ___ her!",
        ...
        ("buzz him in", "/bʌz ɪm ɪn/", "phrase 按门铃让他进", "B2", "short_u", ["生活词汇", "公寓"],
         "___! (按门禁让他进来)",
         "Buzz him in!",
         "快开门让他进来！",
        ...
        ("Dear Diary moment", "/dɪə ˈdaɪəri ˈməʊmənt/", "n. phrase 值得写进日记的大事", "B2", "long_a", ["习语", "幽默"],
         "Ooh, this is a ___.",
        ...
        ("squatting", "/ˈskwɒtɪŋ/", "v. 蹲着", "B2", "short_o", ["动作", "CET6"],
         "(Ross is ___ and reading the instructions)",
         "(Ross is squatting and reading the instructions)",
         "（Ross蹲在地上读说明书。）",
         "squat 深蹲（健身）/ 蹲坐；另外也指擅自占住空屋（squatter=占屋者）。",
         "Ross's Apartment", "squatting"),

        ("brackety thing", "/ˈbrækəti θɪŋ/", "n. phrase（瞎编的）那个支架玩意儿", "B1", "short_a", ["口语", "瞎编词汇"],
        ...
        ("worm guys", "/wɜːm ɡaɪz/", "n. phrase（瞎编的）螺丝小子们", "B1", "r-controlled_vowel", ["口语", "幽默"],
        ...
        ("clutching", "/ˈklʌtʃɪŋ/", "v. 紧紧攥着", "B2", "short_u", ["动作", "CET6"],
         "(Ross is ___ a beer can and sniffing)",
         "(Ross is clutching a beer can and sniffing)",
         "（Ross攥着一罐啤酒，闻来闻去。）",
         "clutch = hold tightly（紧紧抓住，常因激动/害怕）；也可做名词=离合器。",
         "Ross's Apartment", "clutching"),

        ("outta here", "/ˈaʊtə hɪə/", "contraction (out of here)", "A2", "schwa", ["连读", "口语缩写"],
        ...
        ("got screwed", "/ɡɒt skruːd/", "phrase 被坑惨了", "B2", "long_u", ["俚语", "情绪"],
         "You ___.",
         "You got screwed.",
         "你简直亏大了 / 你被坑得够惨。",
        ...
        ("caught on", "/kɔːt ɒn/", "phrasal verb 察觉、明白", "B2", "r-controlled_vowel", ["phrasal_verb"],
        ...
        ("steer clear of you", "/stɪə klɪə əv juː/", "phrase 躲你远点儿", "B2", "long_e", ["习语", "幽默"],
         "Ooh, ___!",
        ...
        ("shredded", "/ˈʃredɪd/", "v. 撕成碎片", "B2", "short_e", ["动作", "CET6"],
        ...
        ("cut me off", "/kʌt mi ɒf/", "phrasal verb 挂断我电话", "B2", "short_u", ["phrasal_verb", "通讯"],
        ...
        ("ripped your heart out", "/rɪpt jɔː hɑːt aʊt/", "phrase 把你心都撕烂了", "B2", "short_i", ["习语", "情绪"],
        ...
        ("Grab a spoon", "/ɡræb ə spuːn/", "phrase 拿起勺子=重新开始约会", "B2", "short_a", ["经典金句", "隐喻"],
        ...
        ("flavors of ice cream", "/ˈfleɪvəz əv ˈaɪs kriːm/", "n. 比喻 不同类型的女生", "B1", "long_a", ["经典比喻"],
        ...
        ("a snap in his turtle", "/ə snæp ɪn hɪz ˈtɜːtl/", "phrase （粗俗）他的小弟弟能重振雄风了", "B2", "short_a", ["俚语", "Frannie梗"],
        ...
        ("was a line", "/wɒz ə laɪn/", "phrase 是一句撩妹的套话", "B2", "long_i", ["俚语", "约会"],
         "Of course it ___!",
        ...
        ("beacon", "/ˈbiːkən/", "n. 信标、灯塔般的信号", "C1", "long_e", ["CET6", "比喻"],
        ...
        ("trained for nothing", "/treɪnd fɔː ˈnʌθɪŋ/", "phrase 什么技能都没学过", "B1", "long_a", ["Rachel名言"],
        ...
        ("laughed out of", "/lɑːft aʊt əv/", "phrase 被轰着笑出来=面试惨败", "B2", "short_a", ["习语"],
        ...
        ("upbeat", "/ˈʌpbiːt/", "adj. 乐观的、积极向上的", "B2", "long_e", ["情绪", "CET6"],
        ...
        ("Sweet 'n' Lo", "/swiːt ənd ləʊ/", "n. 甜蜜低卡糖（代糖品牌名）", "B2", "long_e", ["品牌", "生活"],
         "(to the waitress) ___?",
        ...
        ("kinda drifted", "/ˈkaɪndə ˈdrɪftɪd/", "phrase 有点疏远了", "B1", "long_i", ["kinda句型"],
        ...
        ("figure out", "/ˈfɪɡər aʊt/", "phrasal verb 想明白、搞懂", "B1", "short_i", ["phrasal_verb", "高频"],
        ...
        ("mortified", "/ˈmɔːtɪfaɪd/", "adj. 羞愧到想死、囧爆了", "C1", "r-controlled_vowel", ["情绪", "CET6"],
         "Ross: (___) Hi.",
         "Ross: (mortified) Hi.",
         "Ross（脸都丢尽了）：嗨……",
         "mort- 词根=死亡（mortal）→ mortify=羞愧得想死。Ross刚离婚，看到老友尴尬爆了。",
         "Central Perk", "mortified"),

        ("cleansing my aura", "/ˈklenzɪŋ maɪ ˈɔːrə/", "phrase 净化我的气场", "B2", "long_o", ["Phoebe梗", "神秘学"],
        ...
        ("Be murky!", "/biː ˈmɜːki/", "phrase 那就浑浊你的吧！", "B2", "r-controlled_vowel", ["Phoebe名言"],
         "Phoebe: Fine! ___!",
        ...
        ("to hell with her", "/tuː hel wɪð hɜː/", "phrase 让她去死吧/管她呢", "B1", "short_e", ["情绪", "发泄"],
        ...
        ("keep fixating on that", "/kiːp fɪkˈseɪtɪŋ ɒn ðæt/", "phrase 老纠结这事", "B2", "long_a", ["心理", "CET6"],
        ...
        ("take it pretty well", "/teɪk ɪt ˈprɪti wel/", "phrase 接受得挺坦然、挺想得开", "B1", "long_a", ["情绪", "高频词组"],
        ...
        ("hysterical", "/hɪˈsterɪkl/", "adj. 歇斯底里的；极搞笑的", "B2", "short_i", ["情绪", "多义词"],
        ...
        ("have some hormones", "/hæv səm ˈhɔːməʊnz/", "phrase 男人一点、拿出性欲来", "B2", "r-controlled_vowel", ["Joey梗", "幽默"],
         "You're single! ___!",
        ...
        ("a wrong number", "/ə rɒŋ ˈnʌmbə/", "n. 打错的电话", "A2", "short_o", ["基础高频"],
         "What was that? A ___?",
        ...
        ("survivor", "/səˈvaɪvə/", "n. 幸存者", "B2", "long_i", ["CET4", "比喻"],
        ...
        ("four wet bridesmaids", "/fɔː wet ˈbraɪdzmeɪdz/", "n. phrase 四个浑身湿透的伴娘", "B1", "long_a", ["Monica梗", "幽默"],
        ...
        ("de-caff", "/diː kæf/", "n. 无咖啡因咖啡（decaf缩写）", "B2", "short_a", ["生活词汇", "咖啡"],
        ...
        ("wondering", "/ˈwʌndərɪŋ/", "v. 在琢磨、在纳闷", "A2", "schwa", ["A2高频"],
        ...
        ("a big pipe organ", "/ə bɪɡ paɪp ˈɔːɡən/", "n. phrase 大型管风琴", "B2", "long_i", ["Monica肥皂剧梗"],
        ...
        ("on a roll", "/ɒn ə rəʊl/", "phrase 手气正顺、势如破竹", "B2", "long_o", ["习语", "高频"],
        ...
        ("Western omelet", "/ˈwestən ˈɒməlɪt/", "n. 西式洋葱火腿蛋卷", "B2", "short_e", ["生活词汇", "食物"],
         "make a ___…",
        ...
        ("the barn raising scene in Witness", "/ðə bɑːn ˈreɪzɪŋ siːn ɪn ˈwɪtnəs/", "phrase 《目击者》里集体建谷仓的经典温馨场面", "C1", "long_a", ["电影梗", "Paul的夸张比喻"],
        ...
        ("input those numbers", "/ˈɪnpʊt ðəʊz ˈnʌmbəz/", "phrase 把那些数字输进去", "B1", "short_u", ["Chandler冷笑话"],
        ...
        ("regional work", "/ˈriːdʒənəl wɜːk/", "n. phrase 地方剧场演出（非百老汇）", "B2", "long_e", ["Joey演员"],
        ...
        ("a real live boy", "/ə rɪəl laɪv bɔɪ/", "phrase 一个真真正正的小男孩（匹诺曹梗）", "B2", "long_i", ["文化梗", "匹诺曹"],
        ...
        ("stop smiling", "/stɒp ˈsmaɪlɪŋ/", "phrase 别老傻笑了", "A1", "long_i", ["高频词组"],
         "I can't ___.",
        ...
        ("a hanger in your mouth", "/ə ˈhæŋər ɪn jɔː maʊθ/", "phrase 嘴里含了个衣架（形容咧嘴笑到僵）", "B2", "short_a", ["Rachel比喻"],
        ...
        ("a little ahead of ourselves", "/ə ˈlɪtl əˈhed əv aʊəˈselvz/", "phrase 步子迈太大、想太远了", "B2", "schwa", ["习语", "高频"],
        ...
        ("wish me luck", "/wɪʃ mi lʌk/", "phrase 祝我好运", "A2", "short_u", ["高频"],
         "Oh, look, ___!",
        ...
        ("job things", "/dʒɒb θɪŋz/", "n. 那种叫「工作」的玩意儿", "A1", "short_o", ["Rachel金句"],
        ...
        ("push my Aunt Roz through Parrot Jungle", "/pʊʃ maɪ ɑːnt rɒz θruː ˈpærət ˈdʒʌŋɡl/", "phrase 推着轮椅上的Roz阿姨逛鹦鹉丛林乐园", "B2", "short_u", ["Florida梗", "Frannie"],
        ...
        ("take credit for Paul", "/teɪk ˈkredɪt fɔː pɔːl/", "phrase 把Paul的改变归功于我", "B2", "long_a", ["高频词组"],
        ...
        ("severe emotional problems", "/sɪˈvɪə ɪˈməʊʃənəl ˈprɒbləmz/", "phrase 严重的情感问题", "B2", "long_e", ["Monica自嘲"],
        ...
        ("bursts out laughing", "/bɜːsts aʊt ˈlɑːfɪŋ/", "phrase 突然放声大笑", "B2", "r-controlled_vowel", ["动作"],
         "Joey (___ again) I can't believe you didn't know!",
         "Joey (bursts out laughing again) I can't believe you didn't know!",
         "Joey（又爆笑出来）：你居然没听出来那是套话！",
         "burst out doing = 突然开始做某事（笑、哭）；burst into tears/laughter=突然哭/笑。",
         "Central Perk", "bursts out laughing"),

        ("massaging", "/ˈmæsɑːʒɪŋ/", "v. 按摩", "B2", "short_a", ["Phoebe技能", "CET4"],
         "All right, c'mere, gimme your feet. (She starts ___ them.)",
         "All right, c'mere, gimme your feet. (She starts massaging them.)",
         "好了好了过来，把脚给我。（她开始帮Monica按摩脚）",
         "massage n./v.按摩；Phoebe的职业就是masseuse（女按摩师）。",
         "Central Perk", "massaging"),

        ("on sale", "/ɒn seɪl/", "phrase 打折出售中", "A2", "long_a", ["购物高频"],
        ...
        ("fifty percent off", "/ˈfɪfti pəˈsent ɒf/", "phrase 打五折", "A2", "long_i", ["购物数字"],
    ...
    cards = []
    for i, (target_word, ipa, pos, level, vowel_cat, tags,
